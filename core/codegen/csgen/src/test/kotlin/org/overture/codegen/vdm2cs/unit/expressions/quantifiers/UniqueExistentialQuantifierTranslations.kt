...
import org.overture.codegen.vdm2cs.translations.expressions.quantifiers.UniqueExistentialQuantifiers
import org.overture.codegen.vdm2cs.utilities.*

class UniqueExistentialQuantifierTranslations : QuantifierTranslationRuleSpek<AExists1QuantifierExpIR>(
    UniqueExistentialQuantifiers)
{
    init
    {
        "exists1 a in set { 1, ..., 3 } & a >= 1" describesThat
            uniqueExistentialQuantifier(bindings = listOf(setBinding(patterns = listOf(identifierPattern("a")),
            ...
            " select a >= 1).Count(_ => _) == 1"

        "exists1 a, b in set { 1, ..., 6 } & a + b > 4" describesThat
            uniqueExistentialQuantifier(bindings = listOf(setBinding(patterns = listOf(identifierPattern("a"),
                                                                                 identifierPattern("b")),
            ...
            " select a + b > 4).Count(_ => _) == 1"

        "exists1 x in set { 1, ..., 2 }, y, z in set { 1, ..., 4 } & x + y + z = 5" describesThat
            uniqueExistentialQuantifier(bindings = listOf(setBinding(patterns = listOf(identifierPattern("x")),
